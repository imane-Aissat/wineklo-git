...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider.of<FoodieCubit>(context).loadProfile(1);

    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Profile', style: blackSubHeadlineStyle.copyWith(fontSize: screenWidth * 0.05)),
                    ...
                    Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: CircleAvatar(
                            radius: 40,
                            backgroundImage: foodieProfile.photo != null && foodieProfile.photo!.isNotEmpty
                                ? AssetImage(foodieProfile.photo!)
                                : const AssetImage("assets/images/snoopya.jpg") as ImageProvider,
                          ),
                        ),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const EditProfile(foodieID: 1), 
                                ),
                              );
                            },
                            child: const Text(
